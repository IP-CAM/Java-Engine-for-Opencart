 ...
 */
public class TestUserFindAllJson {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        UserDAO locationDAO = new UserDAO();        
        List<EntidadeDominio> entidadeDominio = locationDAO.findAll();
        List<TableUser> user = (List<TableUser>)(List<?>) entidadeDominio;  
        
        /*
        String arrayToJson = new Gson().toJson(user);
        ...
        try {
            ...
            System.out.println("User: " + arrayToJson);
        } catch (JsonProcessingException ex) {
            Logger.getLogger(TestUserFindAllJson.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
}
