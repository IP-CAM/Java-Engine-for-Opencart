                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="stock_status" id="input-stock-status" class="form-control">
                                                    <c:forEach var="stockStatus" items="${stockStatusList}">
                                                        <option value="${stockStatus.id}">${stockStatus.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <input type="number" name="length" value="" placeholder="Comprimento" id="input-length" min="0" class="form-control">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="number" name="width" value="" placeholder="Largura" id="input-width" min="0" class="form-control">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="number" name="height" value="" placeholder="Altura" id="input-height" min="0" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="length_class" id="input-length-class" class="form-control">
                                                    <c:forEach var="length_class" items="${lengthClassList}">
                                                        <option value="${lengthClass.id}">${lengthClass.title}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="weight" value="" placeholder="Peso" id="input-weight" min="0" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="weight_class_id" id="input-weight-class" class="form-control">
                                                    <c:forEach var="weightClass" items="${weightClassList}">
                                                        <option value="${weightClass.id}">${weightClass.title}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
