                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <script>stockStatusFunction(5);</script>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="length-unit">Unidade de medida</label>
                                            <div class="col-sm-10">
                                                <div id="length-unit"></div> 
                                            </div>                                            
                                            <script>lengthUnitFunction(0);</script>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="weight-unit">Unidade de peso</label>
                                            <div class="col-sm-10">
                                                <div id="weight-unit"></div>                                                
                                            </div>
                                            <script>weightUnitFunction(1);</script>
                                        </div>
                                        <div class="form-group">
