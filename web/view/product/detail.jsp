                    ...
                    <div id="content" class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul class="list-unstyled">
                                    <li>Marca: <a href="livraria?rca=PPpL&findBy=Manufacturer&searchValue=${product.manufacturer.id}">${product.manufacturer.name}</a></li>
                                    ...
                                    <li>
                                        <c:forEach var="categoryL1" items="${product.categoryList}">
                                            <a href="/ZZZ_ag_908/livraria?rca=PPpL&findBy=Category&searchValue=${categoryL1.id}">${categoryL1.name}</a>
                                        </c:forEach>
                                    </li>
                                </ul>
                                <ul class="list-unstyled">
                        ...
                        <p>Etiquetas:
                            <c:forEach var="tag" items="${fn:split(product.tag,',')}">
                                <a href="/ZZZ_ag_908/livraria?route=product/search&amp;tag=Banheiro">${tag}</a>,
                            </c:forEach>
                            <a href=""></a>          </p>
                    </div>
                </div>
