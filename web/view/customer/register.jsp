                                    ...
                                    <form class="panel-body" method="post" action="/ZZZ_ag_908/livraria?rca=uCaC">
                                            ...
                                            <div class="col-sm-6">
                                                <fieldset id="account">
                                                    ...
                                                    <div class="form-group required">
                                                        <label class="control-label" for="input-customer-firstname">Nome completo</label>
                                                        <input type="text" name="fullname" value="" placeholder="Nome" id="input-customer-fullname" class="form-control">
                                                    </div>                                                    
                                                    <div class="form-group required">
                                                        <label class="control-label" for="input-customer-email"><i class="fa fa-envelope"></i> E-mail</label>
                                                        <input type="text" name="email" value="" placeholder="E-mail" id="input-customer-email" class="form-control">
                                                    </div>
                                                    <div class="form-group required">
                                        ...
                                        <div class="checkbox">
                                            <label for="newsletter">
                                                <input type="checkbox" name="newsletter" value="1" id="newsletter">Deseja receber novidades, ofertas e promoções da loja Sonhos e Construção em seu e-mail?</label>
                                        </div>                                        
